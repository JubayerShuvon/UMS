...
<div class="w3-container w3-dark-white" style="margin-top:50px">
  <form onclick="return validation()" method="post" action="../controller/fund.php">

   <p>Your librarian ID: </p> <input type="number" name="vid" id="vid" placeholder="Enter ID " onkeypress="checkID()" onblur="checkID()">
